...
<div class="flex items-center justify-center min-h-screen bg-gradient-to-r from-zinc-800  to-zinc-600" id="about" data-animate>
    <div class="w-full max-w-lg   bg-transparent backdrop-blur-md bg-opacity-30 border border-gray-200 rounded-lg ">
        <div class="flex justify-end px-4 pt-4">


        </div>
        <div class="flex justify-center flex-col items-center pb-10 pl-10 pr-10" data-animate>
            <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="/images/June-removebg-preview.png"
                alt="Bonnie image" />
