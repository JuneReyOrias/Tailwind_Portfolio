<div class="relative flex justify-center items-center w-full min-h-screen bg-gradient-to-r from-zinc-800  to-zinc-600 pb-8 p-4" >
    ...
    <div class="relative flex flex-col md:flex-row w-full max-w-7xl gap-4">
        ...
        <div class="relative flex items-center justify-center  rounded-md  p-6 w-full md:w-1/2  " data-animate>
            <!-- Fading Effect -->
        ...
        <div class="relative  rounded-full border-1 overflow-hidden flex items-center justify-center">
            <img class=" w-full h-full object-cover" src="/images/June-removebg-preview.png" alt="June Rey Orias">
        </div>
        ...
        <div class="relative flex flex-col justify-center items-center p-6 w-full md:w-1/2" data-animate>
